...
def seed_db():
    ...
    UTILS.add_committment(1, 10000000, datetime.
                          strptime('31/12/2017', '%d/%m/%Y'))
    UTILS.add_committment(2, 15000000, datetime.
                          strptime('31/03/2018', '%d/%m/%Y'))
    UTILS.add_committment(3, 10000000, datetime.
                          strptime('30/06/2018', '%d/%m/%Y'))
    UTILS.add_committment(4, 15000000, datetime.
                          strptime('30/09/2018', '%d/%m/%Y'))
    UTILS.add_committment(1, 10000000, datetime.
                          strptime('31/12/2018', '%d/%m/%Y'))
    UTILS.add_capitalcall('investment_1', 9500000, datetime.
                          strptime('31/01/2018', '%d/%m/%Y'))
    UTILS.add_capitalcall('investment_2', 10000000, datetime.
